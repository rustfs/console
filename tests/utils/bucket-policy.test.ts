...
describe('createAllowStatement', () => {
  it('should create valid allow statement', () => {
    const statement = createAllowStatement(
      ['*'],
      [PolicyAction.GetObject],
      [{ bucket: 'my-bucket', object: '*' }]
    )
...
describe('createDenyStatement', () => {
  it('should create valid deny statement', () => {
    const statement = createDenyStatement(
      ['*'],
...
describe('createBucketPolicy', () => {
  ...
  it('should throw error for invalid policy', () => {
    ...
    expect(() => createBucketPolicy(invalidStatements))
      .toThrow('Invalid bucket policy')
  })
})
...
describe('setBucketPolicy', () => {
  ...
  it('should replace existing policy', () => {
    ...
    const newStatements = setBucketPolicy(
      existingStatements,
      BucketPolicyConstants.Public,
      'my-bucket',
      'prefix/'
    )
